...
public class ConfigConstants {
    ...
    private static String pptPreviewPage;
    ...
    public static String getPptPreviewPage() {
        return pptPreviewPage;
    }

    @Value("${ppt.preview.page:officePicture}")
    public void setPptPreviewPage(String pptPreviewPage) {
        setPptPreviewPageValue(pptPreviewPage);
    }

    public static void setPptPreviewPageValue(String pptPreviewPage) {
        ConfigConstants.pptPreviewPage = pptPreviewPage;
    }
}
